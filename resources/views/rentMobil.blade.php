    ...
    <div class="container my-5">
        <div class="row align-items-start gy-4">
            ...
            <div class="col-lg-5 text-center bike-image">
                <img src="{{ asset('storage/' . $vehicles->gambar) }}" alt="{{ $vehicles->name }}"
            ...
            <div class="col-lg-7">
                ...
                @endif
                <!-- Formulir -->
                <form method="POST" action="{{ route('rent.mobil') }}" class="rental-form">
                    @csrf
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="date" class="form-control form-detail-control" id="tanggal_rental"
                                name="tanggal_rental" required min="{{ date('Y-m-d') }}">
                        </div>
                        <div class="col-md-6 mb-3">
                    ...
                    <input type="hidden" name="harga" value="{{ $vehicles->harga }}">
                    <input type="hidden" name="mobil_id" value="{{ $vehicles->id }}">
                    <input type="hidden" name="nama_kendaraan" value="{{ $vehicles->nama }}">
