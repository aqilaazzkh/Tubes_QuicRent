    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item"><a class="nav-link" href="{{ route('admin.vehicles.index') }}">Mobil</a></li>
                <li class="nav-item"><a class="nav-link" href="{{ route('admin.motors.index') }}">Motor</a></li>
                <li class="nav-item"><a class="nav-link" href="{{ route('admin.pemesanan.index') }}">Pemesanan</a></li>
