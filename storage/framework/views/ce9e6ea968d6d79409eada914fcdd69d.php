...
<body>
    <div class="container">
        ...
        <form method="POST" action="<?php echo e(route('admin.vehicles.store')); ?>" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
        ...
        <a class="back-link" href="<?php echo e(route('admin.vehicles.index')); ?>">← Kembali ke Daftar Kendaraan</a>
    </div>
</body>

</html><?php /**PATH C:\xampp\htdocs\qila\Laravel\quickrent3\resources\views/admin/Mobil/MobilCreate.blade.php ENDPATH**/ ?>