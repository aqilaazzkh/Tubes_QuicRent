...
<body class="bg-blue-100 flex items-center justify-center min-h-screen">
    <div class="bg-blue-50 rounded-lg shadow-lg p-8 w-full max-w-md">
        ...
        <form action="<?php echo e(route('loginuser')); ?>" method="POST" class="space-y-6">
            <?php echo csrf_field(); ?>
...
<?php /**PATH C:\xampp\htdocs\qila\Laravel\quickrent3\resources\views/login.blade.php ENDPATH**/ ?>