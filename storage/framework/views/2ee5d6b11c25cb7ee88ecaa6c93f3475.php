...
<head>
    ...
    <title>Mau Ngapain Login Admin?!</title>
    <link href="https://cdn.jsdelivr.net/npm/tailwindcss@2.2.19/dist/tailwind.min.css" rel="stylesheet">
</head>

<body class="bg-blue-100 flex items-center justify-center min-h-screen">
    <div class="bg-blue-50 rounded-lg shadow-lg p-8 w-full max-w-md">
        <h2 class="text-center text-2xl font-semibold text-gray-800 mb-8">Mau Ngapain Login Admin?!</h2>
...
<?php /**PATH C:\xampp\htdocs\qila\Laravel\quickrent3\resources\views/admin/login.blade.php ENDPATH**/ ?>