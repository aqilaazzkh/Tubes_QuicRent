...
<body>
    <div class="container">
        ...
        <form method="POST" action="<?php echo e(route('admin.motors.store')); ?>" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
        ...
        <a class="back-link" href="<?php echo e(route('admin.motors.index')); ?>">← Kembali ke Daftar Motor</a>
    </div>
</body>

</html>
<?php /**PATH C:\xampp\htdocs\qila\Laravel\quickrent3\resources\views/admin/Motor/MotorCreate.blade.php ENDPATH**/ ?>