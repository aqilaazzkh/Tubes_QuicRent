    ...
    <div class="container my-5">
        <div class="row align-items-start gy-4">
            ...
            <div class="col-lg-5 text-center bike-image">
                <img src="<?php echo e(asset('storage/' . $motor->gambar)); ?>" alt="<?php echo e($motor->nama_kendaraan); ?>"
            ...
            <div class="col-lg-7">
                ...
                <!-- Formulir -->
                <form id="rental-form" method="POST" action="<?php echo e(route('rent.motor')); ?>" class="rental-form">
                    <?php echo csrf_field(); ?>
                    ...
                    <!-- Hidden Inputs -->
                    <input type="hidden" id="motor_id" name="motor_id" value="<?php echo e($motor->id); ?>" />
...
</html><?php /**PATH C:\xampp\htdocs\qila\Laravel\quickrent3\resources\views/detail.blade.php ENDPATH**/ ?>