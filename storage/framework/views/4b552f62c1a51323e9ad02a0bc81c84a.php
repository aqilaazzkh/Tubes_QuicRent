...
<body class="bg-blue-100 flex items-center justify-center min-h-screen">
    <div class="bg-blue-50 rounded-lg shadow-lg p-8 w-full max-w-md">
        <h2 class="text-center text-2xl font-semibold text-gray-800 mb-8">Register</h2>
        ...
        <form action="<?php echo e(route('registerUser')); ?>" method="POST" class="space-y-6">
            <?php echo csrf_field(); ?>
...
<?php /**PATH C:\xampp\htdocs\qila\Laravel\quickrent3\resources\views/register.blade.php ENDPATH**/ ?>